...
int32_t gci_i2c_read(i2c_inst_t *i2c, uint8_t addr, uint8_t reg, uint8_t *dst,
                     uint32_t size);
int32_t gci_i2c_write(i2c_inst_t *i2c, uint8_t addr, uint8_t reg, uint8_t *src,
                      uint32_t size);
// inline int32_t gci_i2c_write(i2c_inst_t *i2c, uint8_t addr, uint8_t *src,
// uint32_t size) {
//   return return i2c_write_blocking(i2c, addr, src, size, I2C_RELEASE_BUS);
// }
size_t gci_i2c_available(i2c_inst_t *i2c);
// inline size_t gci_i2c_available(i2c_inst_t *i2c) { return
...
// int32_t gci_i2c0_read(uint8_t addr, uint8_t reg, uint8_t *dst, uint32_t
// size); int32_t gci_i2c0_write(uint8_t addr, uint8_t reg, uint8_t *src,
// uint32_t size); int32_t gci_i2c1_read(uint8_t addr, uint8_t reg, uint8_t
// *dst, uint32_t size); int32_t gci_i2c1_write(uint8_t addr, uint8_t reg,
// uint8_t *src, uint32_t size); int32_t gci_i2c_read(const gci_i2c_t *hw,
// uint8_t reg, uint8_t *dst, uint32_t size); int32_t gci_i2c_write(const
// gci_i2c_t *hw, uint8_t reg, uint8_t *src, uint32_t size);
